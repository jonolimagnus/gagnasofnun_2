...
CREATE TABLE invoice(
    ...
    CONSTRAINT FK_custumerInvoice FOREIGN KEY (CUS_CODE),
	
);

INSERT INTO invoice(CUS_code, INV_NUMBER, INV_DATE)
value
...
CREATE TABLE line(
    ...
    CONSTRAINT LINE_PK PRIMARY KEY (LIN_ID),
    CONSTRAINT FK_INVOICELINE FOREIGN KEY (INV_NUMBER),
);
...
CREATE TABLE product(
    ...
    CONSTRAINT LINEPRODUCT_FK FOREIGN KEY (LIN_ID),
...
CREATE TABLE vendor(
    ...
    CONSTRAINT EMPLOYEE_FK FOREIGN KEY (emp_num),
);
...
VALUE
	(101,'SALES MANAGER','PHELPS','WILLIAM','w',1967-6-6 13:23:45,1989-3-6 12:04:25,'00162',242-9876,101);

INSERT INTO employee(emp_num,emp_title,emp_lname,emp_fname,emp_initial,emp_dob,emp_hir_date,emp_areacode,emp_phone,emp_mgr)
VALUE
	(102,'SALE ASSIT','RICHARDS','STAN','S',1996-2-34 12:34:54,2013-4-5,'00256',324-6875,101);

INSERT INTO employee(emp_num,emp_title,emp_lname,emp_fname,emp_initial,emp_dob,emp_hir_date,emp_areacode,emp_phone,emp_mgr)
VALUE
	(103,'SALE ASSIt','LANTON','FRANK','F',1988-12-25 13:23:43,2006-3-13 14:23:34,'00268',254-5675,101);